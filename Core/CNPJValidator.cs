...
namespace CNPJValidatorV2.Core
{
    ...
    {
        private static readonly int[] Weights = new[] { 2, 3, 4, 5, 6, 7, 8, 9 };
        ...
        public static bool IsValid(string input)
        {
            ...
            {
                return CalculateDv(input.Substring(0, 12)) == input;
            }
        ...
        public static string FormatCnpj(this string input)
        {
            ...
            builder.Append(input.Substring(0, 2)).Append('.')
                   .Append(input.Substring(2, 3)).Append('.')
                   .Append(input.Substring(5, 3)).Append('/')
                   .Append(input.Substring(8, 4)).Append('-')
                   .Append(input.Substring(12, 2));
